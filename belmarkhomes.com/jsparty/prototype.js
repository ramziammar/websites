...
Ajax.Request.prototype = Object.extend(new Ajax.Base(), {
  ...
  respondToReadyState: function(readyState) {
    ...
    if (event == 'Complete') {
    	...
    	if(this.transport.responseText && this.transport.responseText.substr(0,12) == 'NOTLOGGEDIN:') {
...
Ajax.Evaluator = function(response) {
	...
	try { eval(response.responseText); }
	catch(er) { errorMessage('Error in Ajax evaluator on line ' + er.lineNumber + ': ' + er.message + '\n\n' + response.responseText); }
}
