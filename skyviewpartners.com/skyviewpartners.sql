...
INSERT INTO `Member` VALUES (1,'Member','2008-12-18 21:21:24','2008-12-19 05:31:45','Junrey','Beduya','jbeduya@gmail.com','8bd8l081phs8g4wcgc0cwc8k8wwgwco',NULL,3,'2008-12-19 05:31:46',0,NULL,NULL,0,'sha1','97v4zw00f50kg048cs0kkowsc8gk8okg0s84kos','en_US',NULL);
...
CREATE TABLE `SiteTree` (
  `ID` int(11) NOT NULL auto_increment,
  `ClassName` enum('SiteTree','Page','GhostPage','UserDefinedForm','ErrorPage','RedirectorPage','VirtualPage','SubscribeForm') character set utf8 default 'SiteTree',
  `Created` datetime default NULL,
  `LastEdited` datetime default NULL,
...
-- Dump completed on 2008-12-18 21:32:33
